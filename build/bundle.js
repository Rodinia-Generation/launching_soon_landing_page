...
var app = (function () {
	...
	function instance$5($$self, $$props, $$invalidate) {
		...
		const launchDate = new Date("Oct 14, 2021 19:00:00");
		...
		function computeTimeLeft() {
			...
			const timeleft = Math.max(0, launchDateTS - now);
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				t7 = space();
				p3 = element("p");
				p3.textContent = "Be there when we reveal how cutting-edge technology enables a\n                healthy planet and a healthy business without compromising the\n                other.";
				t9 = space();
