...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$3, 42, 12, 1460);
    			...
    			add_location(input2, file$3, 49, 12, 1712);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "w-full text-center py-2 rounded bg-rg-milky-blue-light text-white hover:bg-rg-milky-blue focus:outline-none my-1");
    			button.disabled = /*inputInvalid*/ ctx[3];
    			add_location(button, file$3, 56, 12, 1942);
    			attr_dev(div0, "class", "bg-white px-8 py-8 rounded shadow-md text-black w-full");
    			add_location(div0, file$3, 33, 8, 1078);
    			attr_dev(form, "action", "https://formspree.io/f/xzbyadvb");
    			attr_dev(form, "method", "POST");
    			add_location(form, file$3, 32, 4, 1008);
    			attr_dev(div1, "class", "\n    w-10/12 max-w-sm mx-auto\n    py-4 md:py-0 pl-0 md:pl-8\n    flex-grow justify-center flex flex-col\n");
    			add_location(div1, file$3, 27, 0, 886);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input1, /*companyAndTitle*/ ctx[1]);
    			append_dev(div0, t3);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*companyAndTitle*/ 2 && input1.value !== /*companyAndTitle*/ ctx[1]) {
    				set_input_value(input1, /*companyAndTitle*/ ctx[1]);
    			}
    			...
    			if (dirty & /*inputInvalid*/ 8) {
    				prop_dev(button, "disabled", /*inputInvalid*/ ctx[3]);
    			}
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SubmitContactInfo> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("companyAndTitle" in $$props) $$invalidate(1, companyAndTitle = $$props.companyAndTitle);
    		if ("email" in $$props) $$invalidate(2, email = $$props.email);
    		if ("inputInvalid" in $$props) $$invalidate(3, inputInvalid = $$props.inputInvalid);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*fullname, companyAndTitle, email*/ 7) {
    			{
    				if (fullname && companyAndTitle && email) {
    					...
    					if (emailValid && companyAndTitleValid && nameValid) $$invalidate(3, inputInvalid = false); else $$invalidate(3, inputInvalid = true);
    				} else $$invalidate(3, inputInvalid = true);
    			}
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h2 = element("h2");
    			h2.textContent = "We empower sustainable fashion.";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "The fashion industry will change.\n        For an endevour that simply aims to dress people, massive pollution, nontransparent supply chains, unpredictable production times and human exploitation are not tolerable.\n        And with modern technology, now is the time to pursue a safer, faster and cleaner way.";
    			t3 = space();
    			p1 = element("p");
    			t4 = text("At Rodinia Generation, ");
    			b = element("b");
    			t5 = text("we are developing the worlds first ");
    			em = element("em");
    			em.textContent = "Micro Fashion Factory";
    			t7 = text(".\n        We believe the future of fashion production is automated and local. Our manufacturing innovations leverage\n        textile printers, CNC routers, robotic arms and artificial intelligence.\n        We are bringing ultra-fast, local fashion production into reality. Using no harmful chemicals, no water and emitting minimal CO");
    			sub = element("sub");
    			sub.textContent = "2";
    			t9 = text(".");
    			attr_dev(h2, "class", "text-4xl mb-4");
    			add_location(h2, file$2, 1, 4, 64);
    			attr_dev(p0, "class", "mb-3");
    			add_location(p0, file$2, 2, 4, 131);
    			add_location(em, file$2, 8, 69, 564);
    			add_location(b, file$2, 8, 31, 526);
    			add_location(sub, file$2, 11, 135, 931);
    			attr_dev(p1, "class", "mb-3");
    			add_location(p1, file$2, 7, 4, 478);
    			attr_dev(div, "class", "w-full max-w-2xl mx-auto pb-4 md:pb-0 md:pr-8");
